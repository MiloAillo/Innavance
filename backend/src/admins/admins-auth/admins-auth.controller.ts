...
export class AdminsAuthController {
  ...
  async login(@Body() loginDto: LoginDto) {
    // decorate the loginDto with the validated object as specified in the dto/login.dto.ts
  ...
  async refresh(@Body() refreshDto: RefreshDto) {
    // decorate the refreshDto with the validated object as specified in the dto/refresh.dto.ts
